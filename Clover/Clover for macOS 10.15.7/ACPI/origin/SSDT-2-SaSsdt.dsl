 ...
 *
 * Disassembly of SSDT-2-SaSsdt.aml, Thu Dec 17 23:43:36 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0xC4A7A698, 0x01FE)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Method (LBTU, 1, Serialized)
        {
            If (LEqual (Arg0, Zero))
            {
                Store (DerefOf (Index (LBT0, Zero)), \_SB.PCI0.GFX0.BC00)
                Store (DerefOf (Index (LBT0, One)), \_SB.PCI0.GFX0.BC01)
                Store (DerefOf (Index (LBT0, 0x02)), \_SB.PCI0.GFX0.BC02)
                Store (DerefOf (Index (LBT0, 0x03)), \_SB.PCI0.GFX0.BC03)
                Store (DerefOf (Index (LBT0, 0x04)), \_SB.PCI0.GFX0.BC04)
                Store (DerefOf (Index (LBT0, 0x05)), \_SB.PCI0.GFX0.BC05)
                Store (DerefOf (Index (LBT0, 0x06)), \_SB.PCI0.GFX0.BC06)
                Store (DerefOf (Index (LBT0, 0x07)), \_SB.PCI0.GFX0.BC07)
                Store (DerefOf (Index (LBT0, 0x08)), \_SB.PCI0.GFX0.BC08)
                Store (DerefOf (Index (LBT0, 0x09)), \_SB.PCI0.GFX0.BC09)
                Store (DerefOf (Index (LBT0, 0x0A)), \_SB.PCI0.GFX0.BC10)
                Store (DerefOf (Index (LBT0, 0x0B)), \_SB.PCI0.GFX0.BC11)
                Store (DerefOf (Index (LBT0, 0x0C)), \_SB.PCI0.GFX0.BC12)
                Store (DerefOf (Index (LBT0, 0x0D)), \_SB.PCI0.GFX0.BC13)
                Store (DerefOf (Index (LBT0, 0x0E)), \_SB.PCI0.GFX0.BC14)
                Store (DerefOf (Index (LBT0, 0x0F)), \_SB.PCI0.GFX0.BC15)
                Store (DerefOf (Index (LBT0, 0x10)), \_SB.PCI0.GFX0.BC16)
                Store (DerefOf (Index (LBT0, 0x11)), \_SB.PCI0.GFX0.BC17)
                Store (DerefOf (Index (LBT0, 0x12)), \_SB.PCI0.GFX0.BC18)
                Store (DerefOf (Index (LBT0, 0x13)), \_SB.PCI0.GFX0.BC19)
            }
            ElseIf (LEqual (Arg0, One))
            {
                Store (DerefOf (Index (LBT1, Zero)), \_SB.PCI0.GFX0.BC00)
                Store (DerefOf (Index (LBT1, One)), \_SB.PCI0.GFX0.BC01)
                Store (DerefOf (Index (LBT1, 0x02)), \_SB.PCI0.GFX0.BC02)
                Store (DerefOf (Index (LBT1, 0x03)), \_SB.PCI0.GFX0.BC03)
                Store (DerefOf (Index (LBT1, 0x04)), \_SB.PCI0.GFX0.BC04)
                Store (DerefOf (Index (LBT1, 0x05)), \_SB.PCI0.GFX0.BC05)
                Store (DerefOf (Index (LBT1, 0x06)), \_SB.PCI0.GFX0.BC06)
                Store (DerefOf (Index (LBT1, 0x07)), \_SB.PCI0.GFX0.BC07)
                Store (DerefOf (Index (LBT1, 0x08)), \_SB.PCI0.GFX0.BC08)
                Store (DerefOf (Index (LBT1, 0x09)), \_SB.PCI0.GFX0.BC09)
                Store (DerefOf (Index (LBT1, 0x0A)), \_SB.PCI0.GFX0.BC10)
                Store (DerefOf (Index (LBT1, 0x0B)), \_SB.PCI0.GFX0.BC11)
                Store (DerefOf (Index (LBT1, 0x0C)), \_SB.PCI0.GFX0.BC12)
                Store (DerefOf (Index (LBT1, 0x0D)), \_SB.PCI0.GFX0.BC13)
                Store (DerefOf (Index (LBT1, 0x0E)), \_SB.PCI0.GFX0.BC14)
                Store (DerefOf (Index (LBT1, 0x0F)), \_SB.PCI0.GFX0.BC15)
                Store (DerefOf (Index (LBT1, 0x10)), \_SB.PCI0.GFX0.BC16)
                Store (DerefOf (Index (LBT1, 0x11)), \_SB.PCI0.GFX0.BC17)
                Store (DerefOf (Index (LBT1, 0x12)), \_SB.PCI0.GFX0.BC18)
                Store (DerefOf (Index (LBT1, 0x13)), \_SB.PCI0.GFX0.BC19)
            }
            Else
            {
                Store (DerefOf (Index (LBT2, Zero)), \_SB.PCI0.GFX0.BC00)
                Store (DerefOf (Index (LBT2, One)), \_SB.PCI0.GFX0.BC01)
                Store (DerefOf (Index (LBT2, 0x02)), \_SB.PCI0.GFX0.BC02)
                Store (DerefOf (Index (LBT2, 0x03)), \_SB.PCI0.GFX0.BC03)
                Store (DerefOf (Index (LBT2, 0x04)), \_SB.PCI0.GFX0.BC04)
                Store (DerefOf (Index (LBT2, 0x05)), \_SB.PCI0.GFX0.BC05)
                Store (DerefOf (Index (LBT2, 0x06)), \_SB.PCI0.GFX0.BC06)
                Store (DerefOf (Index (LBT2, 0x07)), \_SB.PCI0.GFX0.BC07)
                Store (DerefOf (Index (LBT2, 0x08)), \_SB.PCI0.GFX0.BC08)
                Store (DerefOf (Index (LBT2, 0x09)), \_SB.PCI0.GFX0.BC09)
                Store (DerefOf (Index (LBT2, 0x0A)), \_SB.PCI0.GFX0.BC10)
                Store (DerefOf (Index (LBT2, 0x0B)), \_SB.PCI0.GFX0.BC11)
                Store (DerefOf (Index (LBT2, 0x0C)), \_SB.PCI0.GFX0.BC12)
                Store (DerefOf (Index (LBT2, 0x0D)), \_SB.PCI0.GFX0.BC13)
                Store (DerefOf (Index (LBT2, 0x0E)), \_SB.PCI0.GFX0.BC14)
                Store (DerefOf (Index (LBT2, 0x0F)), \_SB.PCI0.GFX0.BC15)
                Store (DerefOf (Index (LBT2, 0x10)), \_SB.PCI0.GFX0.BC16)
                Store (DerefOf (Index (LBT2, 0x11)), \_SB.PCI0.GFX0.BC17)
                Store (DerefOf (Index (LBT2, 0x12)), \_SB.PCI0.GFX0.BC18)
                Store (DerefOf (Index (LBT2, 0x13)), \_SB.PCI0.GFX0.BC19)
            }
        }
