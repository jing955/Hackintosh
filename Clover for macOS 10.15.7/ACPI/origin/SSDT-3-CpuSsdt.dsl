 ...
 *
 * Disassembly of SSDT-3-CpuSsdt.aml, Thu Dec 17 23:43:36 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000017B4 (6068)
 *     Revision         0x02
 *     Checksum         0x74
 *     OEM ID           "CpuRef"
...
DefinitionBlock ("", "SSDT", 2, "CpuRef", "CpuSsdt", 0x00003000)
{
    ...
    External (MSMI, MethodObj)    // 1 Arguments (from opcode)
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0xBD99D000, 0x006C)
