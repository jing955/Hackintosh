 ...
 *
 * Disassembly of SSDT-1-DptfTabl.aml, Thu Dec 17 23:43:36 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000AAC7 (43719)
 *     Revision         0x02
 *     Checksum         0x53
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.DPPF, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.DPTE, IntObj)    // (from opcode)
    ...
    External (VGTY, IntObj)    // (from opcode)
                ...
                If (LAnd (LEqual (\DPPP, 0x02), CondRefOf (\_PR.APSV)))
                {
                    ...
                    If (LAnd (LAnd (LEqual (IID0, EID0), LEqual (IID1, EID1)), LAnd (LEqual (IID2, EID2), LEqual (IID3, EID3))))
                    {
                        If (Not (And (STS1, One)))
                        {
                            ...
                            {
                                Store (0x6E, \_PR.APSV)
                                Or (\_SB.PCI0.LPCB.H_EC.DPTE, One, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
                            Else
                            {
                                Store (PTRP, \_PR.APSV)
                                And (\_SB.PCI0.LPCB.H_EC.DPTE, 0x0E, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
                    ...
                    If (LAnd (LAnd (LEqual (IID0, EID0), LEqual (IID1, EID1)), LAnd (LEqual (IID2, EID2), LEqual (IID3, EID3))))
                    {
                        If (Not (And (STS1, One)))
                        {
                            If (And (CAP1, One))
                            {
                                Store (0x6E, \_PR.AAC0)
                                Store (Zero, \_TZ.ETMD)
                                Or (\_SB.PCI0.LPCB.H_EC.DPTE, 0x02, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
                            Else
                            {
                                Store (ATRP, \_PR.AAC0)
                                Store (One, \_TZ.ETMD)
                                And (\_SB.PCI0.LPCB.H_EC.DPTE, 0x0D, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
                ...
                If (LAnd (LEqual (\DPCP, One), CondRefOf (\_PR.ACRT)))
                {
                    ...
                    If (LAnd (LAnd (LEqual (IID0, EID0), LEqual (IID1, EID1)), LAnd (LEqual (IID2, EID2), LEqual (IID3, EID3))))
                    {
                        If (Not (And (STS1, One)))
                        {
                            ...
                            {
                                Store (0xD2, \_PR.ACRT)
                                Or (\_SB.PCI0.LPCB.H_EC.DPTE, 0x04, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
                            Else
                            {
                                Store (YTRP, \_PR.ACRT)
                                And (\_SB.PCI0.LPCB.H_EC.DPTE, 0x0B, \_SB.PCI0.LPCB.H_EC.DPTE)
                                Store (\_SB.PCI0.LPCB.H_EC.DPTE, \_SB.PCI0.LPCB.H_EC.DPPF)
                            }
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (SEN1)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (ECON)
                {
                    Store (\_SB.PCI0.LPCB.H_EC.TSR1, Local0)
            ...
            Method (PAT0, 1, Serialized)
            {
                If (ECON)
                {
                    ...
                    If (LEqual (Local0, Zero))
                    {
                        ...
                        Store (Zero, \_SB.PCI0.LPCB.H_EC.TSI)
                        Store (0x02, \_SB.PCI0.LPCB.H_EC.HYST)
                        Store (FAUX, \_SB.PCI0.LPCB.H_EC.TSLT)
            ...
            Method (PAT1, 1, Serialized)
            {
                If (ECON)
                {
                    ...
                    If (LEqual (Local0, Zero))
                    {
                        ...
                        Store (Zero, \_SB.PCI0.LPCB.H_EC.TSI)
                        Store (0x02, \_SB.PCI0.LPCB.H_EC.HYST)
                        Store (SAUX, \_SB.PCI0.LPCB.H_EC.TSHT)
                        \_SB.PCI0.LPCB.H_EC.ECMD (0x4B)
                        Release (\_SB.PCI0.LPCB.H_EC.PATM)
                    }
                }
            }
    ...
    Scope (\_SB.IETM)
    {
        Name (BDV1, Package (0x01)
        {
            Buffer (0x0557)
            {
                ...
                /* 0030 */  0x00, 0x00, 0x00, 0xBC, 0x00, 0x00, 0x00, 0x04,
                ...
                /* 0078 */  0x44, 0x34, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01,
                /* 0080 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 0088 */  0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00,
                /* 0090 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x68,
                /* 0098 */  0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                ...
                /* 00B8 */  0x00, 0x00, 0x00, 0xA8, 0x61, 0x00, 0x00, 0x00,
                /* 00C0 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFA,
                /* 00C8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 00D0 */  0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00,
                /* 00D8 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x0A,
                /* 00E0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 00E8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 00F0 */  0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x26,
                /* 00F8 */  0x00, 0x00, 0x00, 0x2F, 0x70, 0x61, 0x72, 0x74,
                /* 0100 */  0x69, 0x63, 0x69, 0x70, 0x61, 0x6E, 0x74, 0x73,
                /* 0108 */  0x2F, 0x54, 0x43, 0x50, 0x55, 0x2E, 0x44, 0x30,
                /* 0110 */  0x2F, 0x6C, 0x61, 0x73, 0x74, 0x5F, 0x65, 0x77,
                /* 0118 */  0x6D, 0x61, 0x5F, 0x70, 0x6F, 0x77, 0x65, 0x72,
                /* 0120 */  0x00, 0x1A, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0128 */  0x00, 0xB0, 0x4B, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0130 */  0x00, 0x26, 0x00, 0x00, 0x00, 0x2F, 0x70, 0x61,
                /* 0138 */  0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6E,
                /* 0140 */  0x74, 0x73, 0x2F, 0x54, 0x43, 0x50, 0x55, 0x2E,
                /* 0148 */  0x44, 0x30, 0x2F, 0x6C, 0x61, 0x73, 0x74, 0x5F,
                /* 0150 */  0x70, 0x6F, 0x77, 0x65, 0x72, 0x5F, 0x75, 0x73,
                /* 0158 */  0x65, 0x64, 0x00, 0x1A, 0x00, 0x00, 0x00, 0x04,
                /* 0160 */  0x00, 0x00, 0x00, 0xBF, 0x56, 0x00, 0x00, 0x01,
                /* 0168 */  0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x2F,
                /* 0170 */  0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2F, 0x65,
                /* 0178 */  0x78, 0x70, 0x6F, 0x72, 0x74, 0x2F, 0x61, 0x70,
                /* 0180 */  0x61, 0x74, 0x00, 0x07, 0x00, 0x00, 0x00, 0x36,
                /* 0188 */  0x01, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x02,
                /* 0190 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 0198 */  0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
                /* 01A0 */  0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x02,
                /* 01A8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x31,
                /* 01B0 */  0x00, 0x08, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x00,
                /* 01B8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x5C, 0x5F, 0x53,
                /* 01C0 */  0x42, 0x5F, 0x2E, 0x49, 0x45, 0x54, 0x4D, 0x00,
                /* 01C8 */  0x04, 0x00, 0x00, 0x00, 0x0E, 0x00, 0x00, 0x00,
                /* 01D0 */  0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
                /* 01D8 */  0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 01E0 */  0x50, 0x53, 0x56, 0x54, 0x00, 0x08, 0x00, 0x00,
                /* 01E8 */  0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 01F0 */  0x00, 0x31, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01,
                /* 01F8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08,
                /* 0200 */  0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00,
                /* 0208 */  0x00, 0x00, 0x00, 0x31, 0x00, 0x08, 0x00, 0x00,
                /* 0210 */  0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0218 */  0x00, 0x5C, 0x5F, 0x53, 0x42, 0x5F, 0x2E, 0x50,
                /* 0220 */  0x43, 0x49, 0x30, 0x2E, 0x42, 0x30, 0x44, 0x34,
                /* 0228 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00,
                /* 0230 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
                /* 0238 */  0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0240 */  0x00, 0x50, 0x4C, 0x31, 0x4D, 0x49, 0x4E, 0x00,
                /* 0248 */  0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00,
                /* 0250 */  0x00, 0x00, 0x00, 0x00, 0x31, 0x35, 0x30, 0x30,
                /* 0258 */  0x30, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00,
                /* 0260 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00,
                /* 0268 */  0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0270 */  0x00, 0x00, 0x31, 0x00, 0x08, 0x00, 0x00, 0x00,
                /* 0278 */  0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0280 */  0x5C, 0x5F, 0x53, 0x42, 0x5F, 0x2E, 0x50, 0x43,
                /* 0288 */  0x49, 0x30, 0x2E, 0x42, 0x30, 0x44, 0x34, 0x00,
                /* 0290 */  0x04, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00,
                /* 0298 */  0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
                /* 02A0 */  0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 02A8 */  0x50, 0x4C, 0x31, 0x4D, 0x41, 0x58, 0x00, 0x08,
                /* 02B0 */  0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00,
                /* 02B8 */  0x00, 0x00, 0x00, 0x32, 0x35, 0x30, 0x30, 0x30,
                /* 02C0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00,
                /* 02C8 */  0x00, 0x2F, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
                /* 02D0 */  0x2F, 0x65, 0x78, 0x70, 0x6F, 0x72, 0x74, 0x2F,
                /* 02D8 */  0x61, 0x70, 0x63, 0x74, 0x00, 0x07, 0x00, 0x00,
                /* 02E0 */  0x00, 0xEC, 0x01, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 02E8 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 02F0 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 02F8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0300 */  0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
                /* 0308 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00,
                /* 0310 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0318 */  0x00, 0x74, 0x0B, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0320 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0328 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0330 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0338 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0340 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0348 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0350 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0358 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0360 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0368 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0370 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0378 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0380 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0388 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0390 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0398 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 03A0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 03A8 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 03B0 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 03B8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 03C0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 03C8 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 03D0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 03D8 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 03E0 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 03E8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 03F0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 03F8 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0400 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0408 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0410 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0418 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0420 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0428 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0430 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0438 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0440 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0448 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0450 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0458 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0460 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0468 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0470 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0478 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0480 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0488 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 0490 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 0498 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 04A0 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 04A8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 04B0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 04B8 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                /* 04C0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 04C8 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 04D0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00,
                /* 04D8 */  0x00, 0x2F, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
                /* 04E0 */  0x2F, 0x65, 0x78, 0x70, 0x6F, 0x72, 0x74, 0x2F,
                /* 04E8 */  0x61, 0x70, 0x70, 0x63, 0x00, 0x07, 0x00, 0x00,
                /* 04F0 */  0x00, 0x62, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
                /* 04F8 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0500 */  0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01,
                /* 0508 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
                /* 0510 */  0x00, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0518 */  0x00, 0x74, 0x72, 0x69, 0x70, 0x5F, 0x74, 0x65,
                /* 0520 */  0x6D, 0x70, 0x00, 0x08, 0x00, 0x00, 0x00, 0x10,
                /* 0528 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5C,
                /* 0530 */  0x5F, 0x53, 0x42, 0x5F, 0x2E, 0x50, 0x43, 0x49,
                /* 0538 */  0x30, 0x2E, 0x42, 0x30, 0x44, 0x34, 0x00, 0x04,
                /* 0540 */  0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00,
                /* 0548 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
                /* 0550 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00       
            }
        })
        Name (BDV2, Package (0x01)
        {
            Buffer (0xF3)
            {
                ...
                /* 0080 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 0088 */  0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00,
                /* 0090 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xB8,
                /* 0098 */  0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 00A0 */  0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00,
                /* 00A8 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
                /* 00B0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 00B8 */  0x00, 0x00, 0x00, 0x98, 0x3A, 0x00, 0x00, 0x00,
                /* 00C0 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFA,
                /* 00C8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
                /* 00D0 */  0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00,
                /* 00D8 */  0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x0A,
